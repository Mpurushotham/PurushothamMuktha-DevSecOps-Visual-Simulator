...
const InfoModal: React.FC<Props> = ({ isOpen, onClose, currentStageIndex, isSecure }) => {
  ...
  // Mapped indexes: 
  // 0: Code, 1: Build, 2: Container, 3: Test, 4: Compliance, 5: Deploy, 6: Monitor
  const checklistItems = [
    ...
    },
    {
        ...
        desc: "Base images scanned for vulnerabilities; non-root user enforcement.",
    ...
    },
    {
        ...
        desc: "Source code scanned for patterns like SQLi/XSS before deployment.",
    ...
    },
    {
        ...
        desc: "Infrastructure resources validated against OPA policies.",
        ...
        >
            ...
            <div className="flex-1 flex flex-col bg-slate-900 relative">
                ...
                <div className="p-4 border-t border-slate-800 bg-slate-950/30 text-center text-xs text-slate-500">
                    Interactive DevSecOps Demo • Built by Purushotham Muktha
                </div>
            </div>
        </motion.div>
      </div>
